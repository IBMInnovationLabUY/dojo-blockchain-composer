    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                //Si el envío lo realicé yo y ya está en su destino
                if (containers[data[i].carga].origen == "resource:org.acme.sample.VendedorJuguetes#1" && containers[data[i].carga].almacenado == containers[data[i].carga].destino) {
